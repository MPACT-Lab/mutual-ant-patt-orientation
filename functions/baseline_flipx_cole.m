function [RSRP_PL_free, RSRP_PL_two] = baseline_flipx_cole(altitude, fs, use_ground_relfec, save, save_name, use_ori, correct_uav_angle, unknown_angle, ant_filename)
    if nargin < 3
        use_ground_relfec = 0;
    end
    if nargin < 5
    ...
    ugv_angle = 0; % disable BS angle (BS can't rotate like UGV)
